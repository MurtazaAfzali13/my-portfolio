...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    // ایجاد ستاره‌ها با حرکت چند جهتی سریع
    const createStars = () => {
      stars.length = 0;
    ...
    const createPlanets = () => {
     ...
     // سیاره‌های مختلف با ویژگی‌های متفاوت
      const planetTypes = [
        ...
        { radius: 6, color: '#ffe66d', speed: 0.2, distance: 250, rings: false },  // زرد
        ...
        { radius: 13, color: '#5f27cd', speed: 0.32, distance: 480, rings: false },  // بنفش
